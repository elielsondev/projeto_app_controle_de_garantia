...
function AuthAdmin() {
  ...
  return (
    <div className="be-vietnam-pro-black flex flex-col items-center justify-center gap-8 min-h-screen bg-violet-700">
      <form onSubmit={handleLogin} className="flex flex-col gap-2 bg-white p-4 rounded-2xl shadow-lg w-88">
      ...
      <div className="bg-white backdrop-blur-sm rounded-xl p-4 max-w-md mx-4 text-center">
        <p className="text-red-500 font-bold text-sm md:text-base">
          Para criar um novo acesso é necessário ter autorização do administrador
        </p>
      </div>
    </div>
  );
